      ...
      <div className={styles.content}>
        <div className={styles.header}>
          ...
          <p className={styles.subText}>
            ...
            foundations. Made from galvanized steel, they offer fast
            installation, high durability, and minimal environmental impact —
            ideal for both small and large construction projects.
          </p>
        </div>
        ...
        <div className={styles.reasonsGrid}>
          ...
          <div className={styles.infoBox}>
            ...
            <div>
              <h4>Eco-Friendly</h4>
              <p>
                100% recyclable and reusable, with minimal ground disturbance
                and no concrete waste.
              </p>
            </div>
          </div>
        </div>
